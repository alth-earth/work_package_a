> **文档治理声明**
>
> - 本文件角色：文档治理前的场景、来源、架构说明与十日计划混合正文归档，不再作为当前技术参考。
> - 改造时间：2026-08-14（Asia/Shanghai）。
> - 现行文件去向：[SCENARIOS_AND_SOURCES.md](SCENARIOS_AND_SOURCES.md)；当前排期见 [ABC_10_DAY_SPRINT.md](../../ABC_10_DAY_SPRINT.md)。
> - 改造原因：稳定的场景/来源事实与短期日历混在同一文件；治理后本路径只保留稳定技术参考，日历统一归顶层冲刺文档。
