> **文档治理声明**
>
> - 本文件角色：文档治理前的工作包 A 版本记录与旧 README 混合正文归档，不再作为当前变更日志。
> - 改造时间：2026-08-14（Asia/Shanghai）。
> - 现行文件去向：[CHANGELOG.md](CHANGELOG.md)；当前状态见 [work_package_a_handoff.md](work_package_a_handoff.md)。
> - 改造原因：原文件后半部分保留了旧 README，版本历史与操作入口职责混杂；新文件只记录版本变化，完整旧文仍在本归档中逐字保留。
